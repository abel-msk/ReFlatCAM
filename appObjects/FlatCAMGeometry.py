...
class GeometryObject(FlatCAMObj, Geometry):
	...
	def update_ui(self, row=None):
		...
		if len(sel_rows) == 1:
			...
			self.ui.tool_data_label.setText(
				f'<b>{_("Parameters for")}: <font color="{get_fg_blue()}">{_("Tool")} {tooluid}</font></b>')
		else:
			self.ui.tool_data_label.setText(
				f'<b>{_("Parameters for")}: <font color="{get_fg_blue()}">{_("Multiple Tools")}</font></b>')
	...
	def ui_update_v_shape(self, tool_type_txt):
		if tool_type_txt == 'V':
			...
			self.ui.cutz_entry.setToolTip(self.ui.cutzlabel.toolTip())
				...
				if plot_tool is None:
					for tooluid_key in self.tools:
						...
						if 'override_color' in self.tools[tooluid_key]['data']:
							...
							color = get_rand_fg_color(self.app) if self.options['multicolored'] else \
